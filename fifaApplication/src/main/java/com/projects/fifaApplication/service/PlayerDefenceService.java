...
public class PlayerDefenceService implements PlayerDefenceServiceInterface {
    ...
    @Override
    public List<PlayerDefence> findByTackles(int tackles) {
        return repository.findByTackles(tackles);
    }

    @Override
    public List<PlayerDefence> findByTacklesWon(int tacklesWon) {
        return repository.findByTacklesWon(tacklesWon);
    }


    @Override
    public PlayerDefence savePlayer(PlayerDefence user) {
